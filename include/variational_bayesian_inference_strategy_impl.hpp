#ifndef GMSAM_VARIATIONAL_BAYESIAN_INFERENCE_STRATEGY_IMPL_HPP
#define GMSAM_VARIATIONAL_BAYESIAN_INFERENCE_STRATEGY_IMPL_HPP
...
#endif // !GMSAM_VARIATIONAL_BAYESIAN_INFERENCE_STRATEGY_IMPL_HPP
